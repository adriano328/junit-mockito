...
import br.com.apirest.apirestjunit.services.impl.UserServiceImpl;
...
class UserResourceTest {
    ...
    @Test
    void whenFindAllThenReturnAListUsetDto(){
        ...
        assertEquals(LUCAS, response.getBody().get(INDEX).getName());
